...
headers = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.170 Safari/537.36',
...
def get_info(url):
    ...
    try:
        ...
        if selector.xpath('//span[@class="palce_li"]/span/i/text()'):
            area = selector.xpath('//span[@class="palce_li"]/span/i/text()')[0]
        else:
            area = '无'
